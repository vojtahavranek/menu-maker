<template>
  ...
  <button ref="loadingButton" @click="login()">Log in</button>-->
  <v-form>
    <v-container>
      <v-row>
        <v-col cols="12"><h2>Přihlášení</h2></v-col>
      </v-row>
      <v-row>
        <v-col cols="12" sm="6">
          <v-text-field
        ...
        <v-col cols="12" sm="6">
          <v-btn primary large block @click="userLogin">Přihlásit</v-btn>
        </v-col>

        <v-col cols="12" sm="6">
          <router-link :to="{ name: 'register' }">
            <v-btn large block>Registrace</v-btn>
          </router-link>
        </v-col>
      </v-row>
